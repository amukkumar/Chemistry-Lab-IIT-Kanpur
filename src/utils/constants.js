export const researchHighlights = [
    {
        imgpath:
            "https://images.pexels.com/photos/3861457/pexels-photo-3861457.jpeg?auto=compress&cs=tinysrgb&w=1200",
    },
    {
        imgpath:
    ...
    {
        imgpath:
            "https://images.pexels.com/photos/4031323/pexels-photo-4031323.jpeg?auto=compress&cs=tinysrgb&w=1200",
    },
];
export const recentNews = [
    {
        imgpath:
            "https://images.pexels.com/photos/3861457/pexels-photo-3861457.jpeg?auto=compress&cs=tinysrgb&w=1200",
        title: "March 2023, Yao, Yihang, Elmira, Xicheng and Dan went to ACS conference in Indianapolis.",
        subtitle:
            "March 2023, Yao, Yihang, Elmira, Xicheng and Dan went to ACS conference in Indianapolis. We met our alumni Yin and his students.",
        links: {
            title: "science lab",
            path: "www.google.com",
        },
...
export const faqs = [
    {
        heading: "Drining Water Supply and Treatment",
        content: [
            {
                title: "Tailored Reductants for Selenium Removal in Iron Electrocoagulation",
                para: "Department of Energy National Alliance for Water Innovation (2022-2024)",
                author: "PI:  Daniel Giammar",
            },
            {
                title: "Tailored Reductants for Selenium Removal in Iron Electrocoagulation",
                para: "Department of Energy National Alliance for Water Innovation (2022-2024)",
    ...
    {
        heading: "Geochemical Processes in Soil and Groundwater",
        content: [
            {
                title: "Tailored Reductants for Selenium Removal in Iron Electrocoagulation",
                para: "Department of Energy National Alliance for Water Innovation (2022-2024)",
    ...
    {
        heading: "Environmental Impacts of Fossil Energy Byproducts",
        content: [
            {
                title: "Tailored Reductants for Selenium Removal in Iron Electrocoagulation",
                para: "Department of Energy National Alliance for Water Innovation (2022-2024)",
...
export const news = [
    {
        title: "Apr. 18, 2016, the uranium project in our lab was reported in Wash U news as Trap and neutralize: A new way to clean contaminated groundwater.",
        links: {
            title: "science lab",
            path: "www.google.com",
        },
    ...
    {
        title: "Dec 12-16, From Hong Kong Dan traveled to Shanghai to visit Xiaohong Guan at Tongji University.  While in Shanghai he also gave a presentation at Fudan University hosted by Weihua Song.",
        links: {
            title: "science lab",
            path: "www.google.com",
        },
    ...
    {
        title: "Dec 12-16, Dan traveled to Hefei to visit Han-Qing Yu at the University of Science and Technology of China.",
        links: {
            title: "science lab",
            path: "www.google.com",
        },
    ...
    {
        title: "Apr. 15, 2016, Rachel won the first prize in the Research as Art Exihibition held by Department of Earth and Planetary Sciences. The electron microprobe image helps identify mineral composition in flood basalt..",
        links: {
            title: "science lab",
            path: "www.google.com",
        },
    ...
    {
        title: "June 2016, Susan and Hannah joined the group as summer students.",
        links: {
            title: "science lab",
            path: "www.google.com",
        },
    ...
    {
        title: "July 2013, Dan came back to St. Louis after his one-year sabbatical at Princeton University as a Kenan Trust Visiting Professor.",
        links: {
            title: "science lab",
            path: "www.google.com",
        },
        imgpath:
            "https://images.pexels.com/photos/2034892/pexels-photo-2034892.jpeg?auto=compress&cs=tinysrgb&w=600",
    },
    {
        title: "June 2016, Susan and Hannah joined the group as summer students.",
        links: {
...
export const groupActivities = [
    {
        title: "Surge internship poster presentation (2023)",
        links: {
            title: "science lab",
            path: "www.google.com",
        },
        imgpaths: [
            "/assets/images/grp1.jpg",
        ],
    },
    {
        title: "Muktesh Bhatt & Maniratnam MTech completion party  ",
        links: {
            title: "science lab",
            path: "www.google.com",
        },
        imgpaths: [
            "/assets/images/grp2.jpg",
        ],
    },
    {
        title: "Dr. Munish and Dr. Paul field visit along with Shahid Ji",
        links: {
            title: "science lab",
            path: "www.google.com",
        },
        imgpaths: [
            "/assets/images/grp3.jpg",
        ],
    },
    {
        title: "Meet up with Dr. Amritanshu in the (EGL)",
        links: {
            title: "science lab",
            path: "www.google.com",
        },
        imgpaths: [
            "/assets/images/grp4.jpg",
        ],
    },
    {
        title: "Akshat Verma Phd defence dinner party ",
        links: {
            title: "science lab",
            path: "www.google.com",
        },
        imgpaths: [
            "/assets/images/grp5.jpg",
        ],
    },
];
export const educations = [
    {
        title: "Courses Currently Taught at IIT Kanpur",
        points: [
            {
                text: "UG, Computational Methods in Engineering (ESO 208A), ",
                links: {
                    title: "science lab",
                    path: "www.google.com",
                },
                imgpaths: [
                    ...
                    "https://images.pexels.com/photos/3992943/pexels-photo-3992943.jpeg?auto=compress&cs=tinysrgb&w=600",
                ],
            },
            {
                text: "Environmental Quality and Pollution (CE311A)",
                links: {
                    title: "science lab",
                    path: "www.google.com",
                },
            ...
            {
                text: "PG, Physicochemical Principles and Processes (CE 664A)",
                links: {
                    title: "science lab",
                    path: "www.google.com",
                },
            ...
            {
                text: "Surface Water Quality Modeling (CE 760A), Solid-Water Interfacial Processes (CE 767B),",
                links: {
                    title: "science lab",
                    path: "www.google.com",
                },
            ...
            {
                text: "Subsurface Contaminant Fate and Transport (CE 761B), Environmental Quality and Pollution Monitoring Techniques (CE 668A)",
                links: {
                    title: "science lab",
                    path: "www.google.com",
                },
            ...
            {
                text: "Solid-Water Interfacial Processes (modular PG) Spring 2018",
                links: {
                    title: "science lab",
                    path: "www.google.com",
                },
            ...
            {
                text: "Surface Water Quality Modeling (modular PG) Spring 2016",
                links: {
                    title: "science lab",
                    path: "www.google.com",
                },
            ...
            {
                text: "Subsurface Contaminant Fate and Transport (modular PG) Spring 2014",
                links: {
                    title: "science lab",
                    path: "www.google.com",
                },
...
export const teams = [
    ...
    },
    {
        ...
        from: '2020',
        to: '2023',
        designation: 'Current Postdoc',
        mobile: '',
        email: 'munish007@gmail.com',
        studies: 'Graduation-Ongoing',
        colleges: ['University Institue of Technology, Indore', 'IIT , Jabalpur'],
        imgpath: 'assets/images/tem3.jpeg',
        info: ''
...
export const students = [
    {
        name: 'Ashwini Kumar Mohapatra',
        isPrincipal: false,
        from: '2020',
        to: '2023',
        designation: 'Student',
        mobile: '',
        email: 'mohapatraashiwini@yahoo.com',
        studies: 'Graduation-Ongoing',
        colleges: ['University Institue of Technology, Indore', 'IIT , Jabalpur'],
        imgpath: 'assets/images/tem4.jpg',
        info: ''
    ...
    },
    {
        ...
        designation: 'Student',
        mobile: '7856987456',
        email: 'sourav20@iitk.ac.in',
        studies: 'Graduation-Ongoing',
        colleges: ['University Institue of Technology, Indore', 'IIT , Jabalpur'],
        imgpath: 'assets/images/tem6.jpg',
        info: ''
    },
    {
        name: 'Akshat Verma',
...
export const msrStudent = [
    {
        ...
        designation: 'Student',
        mobile: '',
        email: 'ankitb22@iitk.ac.in',
        studies: 'Graduation-Ongoing',
        colleges: ['University Institue of Technology, Indore', 'IIT , Jabalpur'],
        imgpath: 'assets/images/tem8.jpg',
        info: 'Programme-M.tech'
    ...
    },
    {
        ...
        designation: 'Student',
        mobile: '',
        email: 'anikets22@iitk.ac.in',
        studies: 'Graduation-Ongoing',
        colleges: ['University Institue of Technology, Indore', 'IIT , Jabalpur'],
        imgpath: 'assets/images/tem9.jpg',
        info: 'Programme-M.tech'
    ...
    },
    {
        ...
        designation: 'Student',
        mobile: '',
        email: 'kavinash23@iitk.ac.in',
        studies: 'Graduation-Ongoing',
        colleges: ['University Institue of Technology, Indore', 'IIT , Jabalpur'],
        imgpath: 'assets/images/tem10.jpg',
        info: 'Programme-M.tech'
    ...
    },
    {
        ...
        designation: 'Student',
        mobile: '',
        email: 'musahib23@iitk.ac.in',
        studies: 'Graduation-Ongoing',
        colleges: ['University Institue of Technology, Indore', 'IIT , Jabalpur'],
        imgpath: 'assets/images/tem11.png',
    ...
    },
    {
        ...
        designation: 'Student',
        mobile: '',
        email: 'kaiser23@iitk.ac.in',
        studies: 'Graduation-Ongoing',
        colleges: ['University Institue of Technology, Indore', 'IIT , Jabalpur'],
        imgpath: 'assets/images/tem12.jpg',
        info: 'Programme- MS (By Research)'
...
export const research = [
    {
        ...
        points: ['Drinking-Water Supply and Treatment',
            'Drinking-Water Supply and Treatment',
            'Drinking-Water Supply and Treatment'

        ],
        img: ['https://images.pexels.com/photos/256381/pexels-photo-256381.jpeg?auto=compress&cs=tinysrgb&w=1200'],
        faqs: faqs
    },
    {
        topic: 'Research Topics',
